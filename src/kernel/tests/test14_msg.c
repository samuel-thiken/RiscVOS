...
int test14_msg(void *arg)
{
        ...
        pid1 = start_in_kernel(psender1_msg, 4000, 131, "psender1_msg", (void *)(intptr_t)fid1);
        pid2 = start_in_kernel(psender2_msg, 4000, 130, "psender2_msg", (void *)(intptr_t)fid1);
