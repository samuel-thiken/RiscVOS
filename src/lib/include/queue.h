/* Copyright 2003   R. Civalero   L.G.P.L.
   ...
   Inspiré du fichier list.h de Linux
	...
	en premier est le dernier de la liste, c'est é dire l'élément
	précédent la téte de liste.

	Pour créer une file :
	 1) Créer une téte de liste de type 'link',
	 2) L'initialiser avec LIST_HEAD_INIT,
	 3) APRES les avoir crées, ajouter des élements dans la file
	    avec la macro queue_add,
	Les éléments doivent étre des structures contenant au moins un
	...
	Attention : certains pointeurs pointent vers des éléments des
		    ...
		    Les tétes de file/liste sont des liens de chainage
...
/**
 * Initialisation d'une téte de liste (téte de file).
 */
 ...
 * Les zones mémoires données par l'allocateur ou allouées é la compilation
 * sont initialisées é 0 (respectivement par l'allocateur et par le crt0).
 */
 ...
 * ptr_elem  : pointeur vers l'élément é chainer
 * head      : pointeur vers la téte de liste
 * type      : type de l'élément é ajouter
...
/**
 * Macro é usage interne utilisée par la macro queue_add
 ...
 * type      : type de l'élément é récupérer
 * listfield : nom du champ du lien de chainage
 */
 ...
 * head      : pointeur vers la téte de liste
 * type      : type de l'élément é retourner par référence
 * listfield : nom du champ du lien de chainage
...
/**
 * Fonction é usage interne utilisée par la macro ci-dessus
 * head : pointeur vers la téte de liste
...
{
	//On récupére un pointeur vers le maillon
 ...
 * ptr_elem  : pointeur vers l'élément é supprimer
 * listfield : nom du champ du lien de chainage
 */
